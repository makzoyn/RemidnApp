package com.example.reminderapp.hps
...
import com.huawei.hms.messaging.HmsMessageService
import com.huawei.hms.messaging.RemoteMessage
...
class HuaweiPushService: HmsMessageService() {
    ...
    override fun onNewToken(newToken: String) {
        ...
        CoroutineScope(job + errorHandling).launch {
            repository.updateHuaweiToken(newToken)
            decideFcmDeviceRegistration(newToken)
        }
    }
